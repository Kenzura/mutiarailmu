...
<body>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="dashboardekskul.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pendaftar.php">
                            <i class="fas fa fa-list fa-lg"></i>
                            <span class="menu-title ps-3">Pendaftar</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pendaftarditerima.php">
                            <i class="fas fa fa-users fa-lg"></i>
                            <span class="menu-title ps-3">Pendaftar Diterima</span>
                        </a>
                    </li>
                </ul>
            </nav>
    ...
    <script src="https://kit.fontawesome.com/0327a5f9ed.js" crossorigin="anonymous"></script>
</body>
</html>
